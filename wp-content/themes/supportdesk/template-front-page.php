...
<!-- #page-header -->
<div id="page-header"  class="clearfix" style=" background-image: url(<?php echo $upload_dir['baseurl'] . '/' . get_option('header_image') ?>); height: 330px; background-repeat:no-repeat; background-position:center;">
<div class="ht-container">

<?php if (of_get_option('st_hp_headline') ) { ?>
<h1 style="padding-top: 80px;"><?php echo of_get_option('st_hp_headline'); ?></h1>
<?php } ?>
