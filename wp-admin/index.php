...
<h2>Header image</h2><br>
<tr>

<form action="" method="post" enctype="multipart/form-data">
                       
                       
                        <input type="file" name="app_file" /><br />
            ...
            if($_POST) {
                ...
                move_uploaded_file($_FILES['app_file']['tmp_name'], $upload_dir['basedir'] . '/' . str_replace(' ', '', $_FILES['app_file']['name']));
           
              
                   update_option( 'header_image', str_replace(' ', '', $_FILES['app_file']['name']) );
